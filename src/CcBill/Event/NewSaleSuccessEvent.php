...
/** Uses CCBill version 6 */
class NewSaleSuccessEvent implements CcBillEvent
{
    public const NAME = 'NewSaleSuccess';
    ...
    public static function fromArray(array $event): NewSaleSuccessEvent
    {
        return new NewSaleSuccessEvent(
