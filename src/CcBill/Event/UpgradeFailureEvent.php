...
class UpgradeFailureEvent extends NewSaleFailureEvent
{
    ...
    public static function fromArray(array $event): UpgradeFailureEvent
    {
        return new UpgradeFailureEvent(
            ...
            $event[CcBillEventConstants::REFERRING_URL],
            $event[CcBillEventConstants::LIFETIME_SUBSCRIPTION],
            $event[CcBillEventConstants::LIFETIME_PRICE],
